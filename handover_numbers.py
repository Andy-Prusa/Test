...
print("    261 mmHg at 240 min, a mean of 0.92 mmHg/min, against the 3-4")
print("    mmHg/min that Stock measured and that Frumin's 53-minute apnoea")
print("    implies. NOT VERIFIED AT SOURCE -- Frumin is not in this")
print("    repository and that figure is from memory, so treat it as a lead")
print("    to check, not a benchmark. Stock IS verified and IS in the suite.")
print()
