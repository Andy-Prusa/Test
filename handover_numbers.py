...
print("                        shipped   B asympt   C pelshape   D jonesRV")
...
for _nm, _cls, _w in (("shipped", Patient, 1695.6),
                      ("B asymptote at RV", _Asym, 2044.3),
                      ("C Pelosi shape", _PelShape, 1469.8),
...
for _nm, _cls, _f, _t, _g in (("shipped", Patient, 688.6, 961.7, 39.7),
                              ("B asymptote at RV", _Asym, 984.3, 1276.5, 29.7),
                              ("C Pelosi shape", _PelShape, 655.2, 936.6, 43.0),
