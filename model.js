...
function derive(P){
  ...
  // RE-SOLVED ON WATSON & PRIDE 2005, 2026-09-26: 0.0130 -> 0.003057 and
  // +0.00015 -> -0.000147. They measured sitting and supine FRC in the SAME
  // subjects, which is tilt_factor at ~90 degrees: 1.275 lean, 1.032 obese.
  // The old pair gave 2.422 at BMI 43.7 and had the BMI term's SIGN wrong.
  // Mirrors apnoea_core.tilt_gain_lean / tilt_gain_bmi.
  const tg=(P.tiltGainLean===undefined?0.003057:P.tiltGainLean)
          +(P.tiltGainBmi===undefined?-0.000147:P.tiltGainBmi)*Math.max(0,bmi-25);
