...
class Patient:
    ...
    #
    #   * IT IS THE MEN'S EQUATION AND THIS MODEL HAS NO SEX. Women's FRC
    #     carries an age term of 0.001 against men's 0.009 -- nine times
    #     smaller, i.e. essentially flat -- so applying the men's line to
    #     every patient is a real approximation, now visible and costed
    #     nowhere.
