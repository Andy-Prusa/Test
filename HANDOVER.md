...
(inert gas); at those values our Stock slope is 5.41 and 7.56 against a
...
| and nearly inert on the knot | 4.75 → 4.65 across that whole range |
...
**That kills the 3–5 range.** Our obstructed slope is 4.75, which sits inside
