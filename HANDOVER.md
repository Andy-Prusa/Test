...
against 75.8-93.4, when the recoil floor moved. **34 PASS, 2 FAIL** is the
current count. See *THE RECOIL FLOOR*.) The oxygen limb
...
| `stiff_below_rv` 0.05 | 3.94 | -27.3 | **-17%** | -54% |
