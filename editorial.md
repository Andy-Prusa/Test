...
> **PARTLY UNVERIFIED, 2026-09-21.** Frumin 1959 page 789 was seen: it confirms the citation, n=8, and that the airway was PATENT with an oxygen reservoir attached rather than obstructed. O'Loughlin 2020, now held and read, reports Frumin secondhand as 0.4 kPa.min⁻¹ arterial in eight subjects over surgery lasting 18–55 min — which corroborates the rate and the sample size, and puts the 53-minute figure inside their stated range. **Still unverified:** the pH nadir of 6.72, the PaCO₂ of 250 mmHg, and saturation 98–100% throughout, all of which are on pages 790–798 that nobody here has seen. **And the three model figures that follow are regenerated by no script.** Do not submit this paragraph until both are fixed. See `SOURCES.md` §2b.
...
That selects hyperangulated indirect laryngoscopy, for reasons that have nothing to do with intubation success rates. **The choice is between direct and indirect laryngoscopy, and it is a choice about geometry rather than about the view.** Direct laryngoscopy requires a line of sight from the teeth to the glottis, and it buys that line by displacing the tongue into the submandibular space — the space that is unavailable in exactly the patients who need the conduit most. Indirect laryngoscopy abandons the requirement altogether: a hyperangulated blade follows the tongue contour instead of flattening it, and lifts the entire 2–4 cm velopharyngeal and tongue-base segment off the posterior wall — precisely the long, narrow obstruction that our resistance analysis identifies as worst. Once seated, a rigid blade stents the pharynx irrespective of muscle tone, without a mask seal and without a sustained jaw thrust. And its characteristic failure mode — an excellent view with difficult tube delivery — is a weakness in a conventional algorithm but is the *desired state* in one aimed at avoiding CICO. It decouples opening the airway from delivering the tube, and apnoeic oxygenation needs only the first.
