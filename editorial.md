...
> **UNVERIFIED, flagged 2026-09-21.** Page 789 of Frumin 1959 was seen and confirms the citation, n=8, and that the airway was PATENT with an oxygen reservoir attached rather than obstructed. The four figures in the next sentence — pH below 7.0 by 30 minutes, nadir 6.72, PaCO₂ 250 mmHg at 53 minutes, saturation 98–100% — are on pages 790–798, which nobody here has seen. The three model figures that follow them are regenerated by no script. Do not submit this paragraph in this state. See `SOURCES.md` §2b.
